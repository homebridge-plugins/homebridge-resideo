...
export class RoomSensorThermostat extends deviceBase {
  ...
  async parseStatus(): Promise<void> {
    ...
    if (this.sensorAccessory) {
      ...
      this.Thermostat.CurrentTemperature = toCelsiusWithOverride(accessoryValue.indoorTemperature, Number(this.Thermostat.TemperatureDisplayUnits), this.platform.config.options?.convertUnits)
